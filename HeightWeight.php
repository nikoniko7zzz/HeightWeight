      ...
      const myLineChart = new Chart(ctx, { //描画するグラフを、new Chart()によって設定
        ...
        data: {
          ...
          datasets: [{
            ...
            label: '身長に対する標準体重(kg）',
            // label: '体重max(kg）',
            data: picked_tekisei_max,
            borderColor: "rgba(0,0,0,0)",
            backgroundColor: "rgba(116,211,242,0.3)",
            yAxisID: 'y2',
            fill: '3' //塗りつぶし
            // 塗りつぶしについて datasets: に入っているリストは0から順に番号がついている。 体重maxは上から3つ目なのでカウント2、 体重minは上から4つ目なのでカウント3 今回体重max〜minの間を塗りつぶしたいので、体重maxにminまでの塗りつぶしfill:'3'とかく
          }, {

            label: '体重min(kg）',
            // display: false,
            data: picked_tekisei_min,
            borderColor: "rgba(0,0,0,0)",
            backgroundColor: "rgba(0,0,0,0)",
            yAxisID: 'y2'
